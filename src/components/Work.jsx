...
const Work = () => {
  ...
  return (
    <div
      name="work"
      className="bg-[#0a192f] py-16 w-full min-h-screen text-gray-300"
    >
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                ...
                <div className="pt-4">
                  <a href={demoLink} target="_blank" rel="noopener noreferrer">
                    <button className="bg-white m-2 px-4 py-2 rounded-lg font-bold text-center text-gray-700 text-lg">
                      Demo
                    </button>
                  </a>
